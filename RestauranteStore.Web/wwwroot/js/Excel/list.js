...
var KTFileManagerList = function () {
    ...
    const initDropzone = () => {
        ...
        var myDropzone = new Dropzone(id, { // Make the whole body a dropzone
            url: "/ProductExcels/AddExcel", // Set the url for your upload script location
            parallelUploads: 10,
            ...
            //    debugger
            //    var progressBar = document.querySelector(id + " .progress-bar");
            ...
            success: function (result) {
                ...
                if (result.status === 'success') {
                    Swal.fire({
                        ...
                        text: 'The data has been processed successfully', // You can customize the message based on the server response
                    });
                }
            },
        ...
        myDropzone.on("success", function (file, response) {
            ...
            // Here you can choose to perform additional actions
            // (e.g., display a success message to the user)
        });
