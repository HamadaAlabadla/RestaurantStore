...
namespace RestaurantStore.Infrastructure.AutoMapper
{
    public class MapperProfile : Profile
    {
        public MapperProfile()
        {
            ...
            CreateMap<ProductExcel, ProductsExcelViewModel>()
                .ForMember(dist => dist.Manufacturer, src => src.MapFrom(src => src.Manufacturer.ToString()))
                .ForMember(dist => dist.CategoryExcel, src => src.MapFrom(src => src.CategoryExcel.Name));
